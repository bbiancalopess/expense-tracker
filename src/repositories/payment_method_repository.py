...
class PaymentMethodRepository:
    ...
    def __create_payment_from_dict(self, data: dict) -> Optional[PaymentMethod]:
        ...
        try:
            if data.get("type") == PaymentType.CREDIT.value:
                return Credit.from_dict(data)
            elif data.get("type") == PaymentType.DEBIT.value:
    ...
    def get_all(self) -> list[PaymentMethod]:
        try:
            ...
            return [self.__create_payment_from_dict(row) for row in results]
    ...
    def get_by_id(self, payment_id: int) -> Optional[PaymentMethod]:
        try:
            ...
            return self.__create_payment_from_dict(result)
        except Exception as e:
