...
class AddAccountWindow(tk.Toplevel):
    ...
    def create_form_fields(self):
        ...
        bank_label = tk.Label(self.form_frame, text="Banco *", bg=self.colors["white"], fg=self.colors["dark_blue"])
        bank_label.pack(anchor="w", pady=(10, 0))
        self.bank_entry = ttk.Entry(self.form_frame)
        self.bank_entry.pack(fill="x", padx=5, pady=(0, 10))

        # Campo para o saldo
        balance_label = tk.Label(self.form_frame, text="Saldo Inicial *", bg=self.colors["white"], fg=self.colors["dark_blue"])
        balance_label.pack(anchor="w", pady=(10, 0))
        vcmd_balance = (self.register(self.validate_numeric_input), '%P')
        self.balance_entry = ttk.Entry(self.form_frame, validate="key", validatecommand=vcmd_balance)
        self.balance_entry.pack(fill="x", padx=5, pady=(0, 10))

        # Campo para o tipo de conta
        account_type_label = tk.Label(self.form_frame, text="Tipo de Conta *", bg=self.colors["white"], fg=self.colors["dark_blue"])
        ...
        self.account_type_combobox.bind("<<ComboboxSelected>>", self.on_account_type_change)
    ...
    def show_credit_card_fields(self):
        ...
        # Dia de vencimento
        due_day_label = tk.Label(self.credit_card_frame, text="Dia de Vencimento *", bg=self.colors["white"], fg=self.colors["dark_blue"])
        ...
        # Dia de fechamento
        closing_day_label = tk.Label(self.credit_card_frame, text="Dia de Fechamento *", bg=self.colors["white"], fg=self.colors["dark_blue"])
